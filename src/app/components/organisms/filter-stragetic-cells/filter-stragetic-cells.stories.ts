...
// Define component
export default {
    title: 'Organisms/FilterStrageticCells',
    component: FilterStrageticCellsComponent,
...
// Define template
const FilterStrageticCellsTemplate: Story<FilterStrageticCellsComponent> = (args: FilterStrageticCellsComponent) => ({
    props: { ...args },
    template: `<nwn-filter-stragetic-cells></nwn-filter-stragetic-cells>`,
});

export const FilterStrageticCells = FilterStrageticCellsTemplate.bind({});
FilterStrageticCells.storyName = 'Filter stragetic cells';
FilterStrageticCells.args = {};
